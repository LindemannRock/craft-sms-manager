...
return [
    ...
    'All analytics data cleared successfully ({count} records deleted).' => 'すべてのアナリティクスデータを正常に削除しました（ {count} 件のレコードを削除）。',
    'Failed to clear analytics data.' => 'アナリティクスデータの削除に失敗しました。',
    'All SMS logs cleared successfully ({count} records deleted).' => 'すべての SMS ログを正常に削除しました（ {count} 件のレコードを削除）。',
    'Provider handle required' => 'プロバイダーの handle が必要です',
    'Provider not found' => 'プロバイダーが見つかりません',
    'Sender ID handle required' => '送信者 ID の handle が必要です',
    ...
    'Overview' => '概要',
    'Encoding' => 'エンコーディング',
    'All Sender IDs' => 'すべての送信者 ID',
    'Characters' => '文字数',
    'SMS Segments' => 'SMS セグメント数',
    'Encoding Units' => 'エンコーディング単位数',
    'Select the message language. Language controls text direction but not SMS encoding.' => 'メッセージの言語を選択してください。言語はテキストの方向を制御しますが、SMS エンコーディングには影響しません。',
    ...
    '160 septets for one segment or 153 per multipart segment. Extension-table characters consume two septets.' => '1 セグメントでは 160 セプテット、複数パートでは 1 セグメントあたり 153 セプテットです。拡張テーブルの文字は 2 セプテットを消費します。',
    '70 UTF-16 code units for one segment or 67 per multipart segment. Emoji and other astral characters consume two units.' => '1 セグメントでは 70 UTF-16 コード単位、複数パートでは 1 セグメントあたり 67 コード単位です。絵文字などの補助平面文字は 2 単位を消費します。',
    'Historical messages whose content was unavailable keep encoding, character, and segment facts unknown.' => '内容を取得できなかった過去のメッセージでは、エンコーディング、文字数、セグメント数は不明のまま表示されます。',
    'Messages' => 'メッセージ',
    'English' => '英語',
    'Arabic' => 'アラビア語',
    'French' => 'フランス語',
